...
app.use(express.urlencoded({ extended: true, limit: '20mb' }));  // Increase limit to 20MB for URL-encoded bodies
app.use(express.json({ limit: '20mb' }));  // Increase limit to 20MB for JSON bodies
